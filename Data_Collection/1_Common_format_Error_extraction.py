#This script converts all log files to a common format and extracts error logs using Splunk
import subprocess
...
with open("LogLocations.txt") as f:
    content = f.readlines()
try:
    f2 = open("../Temp_Output/ErrorLogs.json","a+")
    f3 = open("../Temp_Output/Clustering.txt","a+")
    ...
    while j<i:
        ...
        if (fext=="evtx"):
            ...
            searchquery_export = "search index=index_test warning"
            ...
            searchquery_export_2 = "search index=index_test warning"
