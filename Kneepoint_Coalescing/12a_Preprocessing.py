#This script performs some pre-processing of log data for further use
import json
import re
...
f2 = open("../Temp_Output/Error_Temp_JSON.txt","w+")
f3 = open("../Temp_Output/Error_JSON_Logs.json","a+")
f4 = open("../Temp_Output/Error_Parsed_JSON_Logs_2.json","a+")
